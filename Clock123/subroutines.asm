...
ready_disp:
	ldi zh,ram_table_h	;load z register for indirect read
	ldi zl,ram_table_l
	sub zl,tens			;compute offset into the table
	ld segs_h,z			;read segments from data table
	ldi zl,ram_table_l	;restore z register
	sub zl,scr			;compute offset
	ld segs_l,z			;read segments from data table
	ret
...
/*s_disp_hr computes the display in the hour set mode

			writes: scr, do_count 			calls: take4000, get_segs_h  */
s_disp_hr:
	ldi scr,8			;five times around
...
/*s_disp_min shows the display in the minute set mode
